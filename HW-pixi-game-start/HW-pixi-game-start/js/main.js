...
function createLabelsandButtons() {
    ...
    gameOverScoreLabel = textStyle;
    gameOverScoreLabel.style.fontSize = 32;
...
function gameLoop(){
    ...
    circles = circles.filter(b =>b.isAlive);
...
function fireBullet(e){
    ...
    let b2 = new Bullet(0xFFFFFF, ship.x + 1, ship.y);
    bullets.push(b2);
    gameScene.addChild(b2);
    let b3 = new Bullet(0xFFFFFF, ship.x - 1, ship.y);
    bullets.push(b3);
